...
<p style="font-size: 14px;">Boss Level example command: "pick up the grey box behind you, then go to the grey key and open a door."</p>
</div>
...
<p style="font-size: 14px;">Language-conditioned Offline Reward Learning (LORel)</p>
</div>
...
<p style="font-size: 14px;">Success rates are shown as percentages. The best method is highlighted in <b>bold</b>.</p>
<p style="font-size: 14px;">Table taken from <a href="#reference-1">[1]</a></p>
</div>
...
[1] Garg, Divyansh, et al. "LISA: Learning Interpretable Skill Abstractions from Language." Advances in Neural Information Processing Systems, vol. 35, 2022. [LISA paper](https://arxiv.org/abs/2203.00054) <br>
...
[4] Maxime Chevalier-Boisvert, Dzmitry Bahdanau, Salem Lahlou, Lucas Willems, Chitwan Saharia, Thien Huu Nguyen, and Yoshua Bengio. Babyai: A platform to study the sample efficiency of grounded language learning, (2019). <br>
[5] Aaron van den Oord, Oriol Vinyals, and Koray Kavukcuoglu. Neural discrete representation learning, (2018). <br>
[6] Victor Sanh, Lysandre Debut, Julien Chaumond, and Thomas Wolf. Distilbert, a distilled version of bert: smaller, faster, cheaper and lighter, (2020). <br>
[7] Suraj Nair, Eric Mitchell, Kevin Chen, Brian Ichter, Silvio Savarese, and Chelsea Finn. Learning language- conditioned robot behavior from offline data and crowd-sourced annotation, (2021) <br>
[8]Dmitry Kalashnikov, Jacob Varley, Yevgen Chebotar, Benjamin Swanson, Rico Jonschkowski, Chelsea Finn, Sergey Levine, and Karol Hausman. Mt-opt: Continuous multi-task robotic reinforcement learning at scale, (2021) <br>
