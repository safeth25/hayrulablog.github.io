...
Let's have a closer look at what Imitation Learning exactly is, to get a better undestanding of it before we dive into how LISA works. In reinforcement learning, am agent interacts with an environment and learns from trial and error guided by a reward function. The goal is to learn a policy which maximizes long-term cumulative rewards. 
This is where IL comes into play. 
