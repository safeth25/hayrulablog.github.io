...
<p>Example command: "pick up the grey box behind you, then go to the grey key and open a door."</p>
</div>

*Figure sourced from the original BabyAI paper.*


<!-- <div align="center">
<img src="/hayrulablog.github.io/images/babyAIDATA.png" alt="LISA Training Algorithm" align="center" width="400"/> 
</div>
*Image sourced from the [original LISA paper](https://arxiv.org/abs/2203.00054).* -->
