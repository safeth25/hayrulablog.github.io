...
**LISA's Training Objective:** LISA is trained end-to-end using an objective function designed to optimize both the behavior-cloning policy and the skill predictor. The objective, $$L_{\text{LISA}}$$, is cimposed of two components: the behavior-cloning loss $$L_{\text{BC}}$$ and the vector quantization loss $$L_{\text{VQ}$$, combined as follow: 
<div align="center">
