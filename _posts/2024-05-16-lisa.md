...
**LOReL Sawyer Dataset:** Next is the LORel Sawyer dataset, which includes 50,000 pseudo-expert trajectories collected from a replay buffer of a random reinforcment learning (RL) policy. Furthermore, these trajectories are annotated with crows-sourced language instructions.

<div align="center">
<img src="/hayrulablog.github.io/images/LOReL.png" alt="LOReL Dataset" align="center" width="400"/> 
<p align="center" width="500">Language-conditioned Offline Reward Learning (LORel)"</p>
</div>
...
- closing or opening a drawer
- turning a handle right or left
- moving a black mug right
- moving a white mug down

Each task was varied by changing nouns, verbs, or the entire instruction to test different aspects of the model's performance, with a total of 77 variations of these tasks.