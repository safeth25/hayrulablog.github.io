...
**BabyAI Dataset**
First up is the BabyAI dataset, which features 19 levels of increasing difficulty in a 7x7 grid world. Agents use a partially observet ego-centrix view to perform tasks like moving objects or opening doors, guided by natural language instructions. 
