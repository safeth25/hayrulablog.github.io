...
**The Policy :** The skill predictor passes the encoded sub-tasks to the policy. Based on these the policy decides what actions to the machine should take next. 
