...
**LISA's Training Objective:** LISA is trained end-to-end using an objective function designed to optimize both the behavior-cloning policy and the skill predictor. The objective, $$L_{\text{LISA}}$$  
