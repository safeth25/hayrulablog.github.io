...
**Original Baselines:** For the BabyAI dataset LISA was comparend against a non-hierarchical recurrent neural network (RNN) based method from the original paper. 
