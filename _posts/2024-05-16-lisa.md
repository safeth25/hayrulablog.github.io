...
**The Skill Predictor:** Here the language instruction is split into two independent sub-tasks "pull the handle" and "move black mug right". Then it predicts quantized skill codes $$z$$ using the vector codebook C.
