...
For language-conditioned skill learning, we augment the MDP with tasks described in natural language. The expert's dataset is represented as . A trajectory consists of observations and actions over timesteps. The goal is to predict the expert's action given past observations and a natural language instruction. 
...
- Divyansh Garg and Skanda Vaidyanath and Kuno Kim and Jiaming Song and Stefano Ermon. LISA: Learning Interpretable Skill Abstractions from Language. 2022