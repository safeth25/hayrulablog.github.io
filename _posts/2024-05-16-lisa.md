...
<p style="font-size: 13px;">Boss Level example command: "pick up the grey box behind you, then go to the grey key and open a door."</p>
</div>
...
<p style="font-size: 13px;">Language-conditioned Offline Reward Learning (LORel)</p>
</div>
...
<p style="font-size: 13px;">Success rates are shown as percentages. The best method is highlighted in <b>bold</b>.</p>
</div>
