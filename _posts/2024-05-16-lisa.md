...
**LOReL Sawyer Dataset:** Next is the LORel Sawyer dataset, which includes 50,000 pseudo-expert trajectories collected from a random reinforcment learning (RL) policy. LISA is evaluated on six tasks: 
- closing and opening a drawer
- turning a faucet right and left
