...
The results presented on the Table above show that LISA either matches or outperforms the strong non-hierarchical Decision Transformer baselines across all tested environments. 